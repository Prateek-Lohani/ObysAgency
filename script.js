...
function cursorAnimation(){
  ...
  var videoContainer = document.querySelector(".img-container");
  var video = document.querySelector(".img-container video")
  ...
  videoContainer.addEventListener("click", function () {
    if (flag == 0) {
      ...
      document.querySelector(".vid-crsr").innerHTML = `<i class="ri-pause-mini-fill"></i>`
      gsap.to(".vid-crsr", {
        scale: 0.5
      })
      flag = 1
      ...
      document.querySelector(".vid-crsr").innerHTML = `<i class="ri-play-mini-fill"></i>`
      gsap.to(".vid-crsr", {
        scale: 1
      })
      flag = 0
